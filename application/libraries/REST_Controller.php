...
abstract class REST_Controller extends CI_Controller
{
	 ...
	 */
	public function response($data = NULL, $http_code = NULL, $continue = FALSE, $writeLog = TRUE)
	{
	 ...
	 * @param int|NULL $http_code HTTP status code
	 */
	public function set_response($data = NULL, $http_code = NULL, $writeLog = TRUE)
	{
		$this->response($data, $http_code, TRUE, $writeLog);
	}
